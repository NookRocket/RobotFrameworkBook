...
:SetPath
rem under JDK 11 use this setup
...
rem JDK 11+ use this setup
@REM set classpaths=%swt_path%\*;%frameworkdir%\*;%ANDROID_HOME%\platforms\android-34\*;%ANDROID_HOME%\cmdline-tools\latest\lib\*
set classpaths=%swt_path%\*;%frameworkdir%\*

call "%java_exe%" -classpath %classpaths% -Dcom.android.uiautomator.bindir=%ANDROID_HOME%\platform-tools com.android.uiautomator.UiAutomatorViewer %*
